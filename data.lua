...
if settings["startup"]["Senpais-Power-Provider"].value then
	...
	accu_entity.picture =
	{
		filename = MODNAME .. "/graphics/" .. accuname.. "-e.png",
		priority = "extra-high",
		width = 124,
		height = 103,
		shift = { 0.6875, -0.203125 }
	}
	accu_entity.charge_animation =
	{
		filename = MODNAME .. "/graphics/" .. accuname .. "-charge.png",
		width = 138,
		height = 135,
		line_length = 8,
		frame_count = 24,
	...
	if settings["startup"]["Senpais-Electric-Train"].value then
		Senpais.Functions.Create.Elec_Locomotive ( 2, "Senpais-Electric-Train", MODNAME .. "/graphics/Senpais-Electric-Train.png", 1000, 2000, 2.5, { r = 83, g = 187, b = 144 }, nil, "transport", "a[train-system]-faa[Senpais-Electric-Train]", 5, { { "locomotive", 1 }, { "battery", 10 }, { "electric-engine-unit", 20 } }, "Senpais-Electric-Train" )
		if settings["startup"]["Senpais-Electric-Train-Heavy"].value then
			...
			Senpais.Functions.Create.Elec_Locomotive( 5, "Senpais-Electric-Train-Heavy", MODNAME .. "/graphics/Senpais-Electric-Train-Heavy.png", 2000, 5000, 2.5, { r = 166, g = 26, b = 26 }, nil, "transport", "a[train-system]-fab[Senpais-Electric-Train-Heavy]", 5, { { "Senpais-Electric-Train", 1 }, { "battery", 20 }, { "electric-engine-unit", 20 } }, "Senpais-Electric-Train-2" )
		end
	end
end
...
if settings["startup"]["Battle-Loco-1"].value then
	Senpais.Functions.Create.Battle_Locomotive( 1, "Battle-Loco-1", MODNAME .. "/graphics/Battle-Loco-1.png", 1000, 2000, 1.2, { r = 213, g = 105, b = 33 }, "Senpais-Trains", "transport", "a[train-system]-fba[Battle-Loco-1]", 5, { { "locomotive", 1 }, { "modular-armor", 1 } }, "modular-armor" )
	if settings["startup"]["Battle-Loco-2"].value then
		Senpais.Functions.Create.Battle_Locomotive( 2, "Battle-Loco-2", MODNAME .. "/graphics/Battle-Loco-2.png", 2000, 4000, 1.4, { r = 101, g = 33, b = 213 }, "Senpais-Trains", "transport", "a[train-system]-fbb[Battle-Loco-2]", 5, { { "Battle-Loco-1", 1 }, { "power-armor", 1 } }, "power-armor" )
		if settings["startup"]["Battle-Loco-3"].value then
			Senpais.Functions.Create.Battle_Locomotive( 3, "Battle-Loco-3", MODNAME .. "/graphics/Battle-Loco-3.png", 3000, 6000, 1.6, { r = 196, g = 0, b = 74 }, "Senpais-Trains", "transport", "a[train-system]-fbc[Battle-Loco-3]", 5, { { "Battle-Loco-2", 1 }, { "power-armor-mk2", 1 } }, "power-armor-2" )
		end
	end
	if settings["startup"][ "Senpais-Power-Provider"].value and settings["startup"]["Senpais-Electric-Train"].value then
		if settings["startup"]["Elec-Battle-Loco-1"].value then
			Senpais.Functions.Create.Elec_Locomotive( 2, "Elec-Battle-Loco-1", MODNAME .. "/graphics/Elec-Battle-Loco-1.png", 1000, 2000, 2.5, { r = 180, g = 136, b = 0 }, "Senpais-Trains", "transport", "a[train-system]-fca[Elec-Battle-Loco-1]", 5, { { "Senpais-Electric-Train", 1 }, { "modular-armor", 1 } }, "modular-armor" )
			if settings["startup"]["Elec-Battle-Loco-2"].value then
				Senpais.Functions.Create.Elec_Locomotive( 4, "Elec-Battle-Loco-2", MODNAME .. "/graphics/Elec-Battle-Loco-2.png", 2000, 4000, 3, { r = 83, g = 166, b = 187 }, "Senpais-Trains", "transport", "a[train-system]-fcb[Elec-Battle-Loco-2]", 5, { { "Elec-Battle-Loco-1", 1 }, { "power-armor", 1 } }, "power-armor" )
				if settings["startup"]["Elec-Battle-Loco-3"].value then
					Senpais.Functions.Create.Elec_Locomotive( 6, "Elec-Battle-Loco-3", MODNAME .. "/graphics/Elec-Battle-Loco-3.png", 3000, 6000, 3.5, { r = 157, g = 0, b = 196 }, "Senpais-Trains", "transport", "a[train-system]-fcc[Elec-Battle-Loco-3]", 5, { { "Elec-Battle-Loco-2", 1 }, { "power-armor-mk2", 1 } }, "power-armor-2" )
				end
			end
		end
	end
...
if settings["startup"]["Battle-Wagon-1"].value then
	Senpais.Functions.Create.Battle_Wagon( "Battle-Wagon-1", nil, 20, 1000, 2000, 1.5, { r = 19, g = 122, b = 156 }, "Senpais-Trains", "transport", "a[train-system]-gaa[Battle-Wagon-1]", 5, { { "cargo-wagon", 1 }, { "modular-armor", 1 } }, "modular-armor" )
	...
	if settings["startup"]["Battle-Wagon-2"].value then
		Senpais.Functions.Create.Battle_Wagon( "Battle-Wagon-2", nil, 40, 2000, 4000, 1.7, { r = 29, g = 127, b = 12 }, "Senpais-Trains", "transport", "a[train-system]-gab[Battle-Wagon-2]", 5, { { "Battle-Wagon-1", 1 }, { "power-armor", 1 } }, "power-armor" )
		...
		if settings["startup"]["Battle-Wagon-3"].value then
			Senpais.Functions.Create.Battle_Wagon( "Battle-Wagon-3", nil, 60, 2000, 6000, 1.9, { r = 156, g = 66, b = 150 }, "Senpais-Trains", "transport", "a[train-system]-gac[Battle-Wagon-3]", 5, { { "Battle-Wagon-2", 1 }, { "power-armor-mk2", 1 } }, "power-armor-2" )
...
if settings["startup"]["Senpais-Dora"].value then
	...
	dora_entity.turret_rotation_speed = 0.0001
	dora_entity.turn_after_shooting_cooldown = 240
